...
var buttonHovers = function buttonHovers() {
  var buttonleft = document.querySelector('.button-l');
  var buttonright = document.querySelector('.button-r');
...
var backgroundElements = function backgroundElements() {
  function positionElements() {
    ...
    var heel = document.querySelector('.heelclip');
    ...
    var dPosY = [screenHeight / 2, screenHeight / screenHeight, screenHeight / 1.5]; //heel.style.top = screenHeight/2;
